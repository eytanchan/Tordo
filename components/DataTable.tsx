                ...
                <td className="p-4">
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <Copy size={12} className="text-gray-600 hover:text-hyper-teal cursor-pointer" />
                        <ExternalLink size={12} className="text-gray-600 hover:text-hyper-teal cursor-pointer" />
                    </div>
                  </div>
                </td>
